The following is a list of assets used in the bitchunks source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://bitchunkstalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original bitchunks logo from Bitboy)
* License: MIT
